package com.ketchupzzz.isaom.presentation.main.teacher.subject.view_subject.modules.edit_module_content
...
import com.ketchupzzz.isaom.presentation.main.teacher.subject.view_subject.modules.create_module_content.ActionButtons
import com.ketchupzzz.isaom.presentation.main.teacher.subject.view_subject.modules.create_module_content.Alignments
import com.ketchupzzz.isaom.presentation.main.teacher.subject.view_subject.modules.create_module_content.ListTypes
...
fun EditContentScreen(
    ...
    Column(
        ...
        PrimaryButton(onClick = {
            events.invoke(
                EditContentEvents.OnCreateContent(
                    moduleID = moduleID,
                    content = content,
                    context = context,
    ...
    LazyVerticalGrid(
        ...
        item {
            ActionButtons(
                ...
                events.invoke(EditContentEvents.OnActionButtonClicked(ActionButtons.BOLD))
            }
        }
        item {
            ActionButtons(
                ...
                events.invoke(EditContentEvents.OnActionButtonClicked(ActionButtons.ITALIC))
            }
        }
        item {
            ActionButtons(
                ...
                events.invoke(EditContentEvents.OnActionButtonClicked(ActionButtons.UNDERLINE))
            }
        }
        item {
            ActionButtons(
                ...
                events.invoke(EditContentEvents.OnActionButtonClicked(ActionButtons.TITLE))
            }
        }
        item {
            ActionButtons(
